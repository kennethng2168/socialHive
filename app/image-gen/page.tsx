...
const imageModels: ImageModel[] = [
  // Amazon Models
  {
    ...
    provider: "Amazon",
    description:
      "Amazon's latest image generation model with exceptional quality and speed",
    speed: "Fast",
    resolution: ["1k", "2k"],
    features: ["High Quality", "Fast Generation", "AWS Integration"],
    category: "text-to-image",
  },
  
  // Self-Hosted Model
  {
    id: "self-hosted-image",
    name: "Self-Hosted Model",
    provider: "Self-Hosted",
    description:
      "Your own self-hosted image generation model for complete control",
    speed: "Standard",
...
export default function ImageGenerationPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      // Route to Amazon Nova Canvas API
      if (selectedModel.id === "amazon-nova-canvas") {
        response = await fetch("/api/nova-canvas", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
      ...
      else if (selectedModel.category === "image-editing" && imageFiles.length > 0) {
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-6">
            <div className="flex items-center gap-4">
              <img src="/mainPage_assets/cookie.png" alt="AI Image Generation Studio" className="h-10" />
              <div>
                <h1 className="text-2xl font-bold text-gray-900">
                  AI Image Generation Studio
                </h1>
                <p className="text-gray-600 text-sm">
                  Turn your ideas into stunning visuals with advanced AI models
                </p>
              </div>
            </div>
          </div>
